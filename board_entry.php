...
$subnav_2 = '';
if ($settings['thread_view']==1) $subnav_2 .= '<span class="small"><a href="forum_entry.php?id='.$thread["tid"].'&amp;page='.$page.'&amp;order='.$order.'&amp;descasc='.$descasc.'&amp;category='.$category.'" title="'.$lang['thread_view_linktitle'].'"><img src="img/thread.gif" alt="" width="12" height="9" title="'.$lang['thread_view_linktitle'].'" />'.$lang['thread_view_linkname'].'</a></span>';
if ($settings['mix_view']==1) $subnav_2 .= '&nbsp;&nbsp;<span class="small"><a href="mix_entry.php?id='.$thread["tid"].'&amp;page='.$page.'&amp;order='.$order.'&amp;descasc='.$descasc.'&amp;category='.$category.'" title="'.$lang['mix_view_linktitle'].'"><img src="img/mix.gif" alt="" width="12" height="9" title="'.$lang['mix_view_linktitle'].'" />'.$lang['mix_view_linkname'].'</a></span>';
if ($da=="DESC") $subnav_2 .= '&nbsp;&nbsp;<span class="small"><a href="board_entry.php?id='.$thread["tid"].'&amp;da=ASC&amp;page='.$page.'&amp;order='.$order.'&amp;descasc='.$descasc.'&amp;category='.$category.'" title="'.$lang['order_linktitle_3'].'"><img src="img/order.gif" alt="" width="12" height="9" title="'.$lang['order_linktitle_3'].'" />'.$lang['order_linkname'].'</a></span>';
else $subnav_2 .= '&nbsp;&nbsp;<span class="small"><a href="board_entry.php?id='.$thread["tid"].'&amp;da=DESC&amp;page='.$page.'&amp;order='.$order.'&amp;descasc='.$descasc.'&amp;category='.$category.'" title="'.$lang['order_linktitle_4'].'"><img src="img/order.gif" alt="" width="12" height="9" title="'.$lang['order_linktitle_4'].'" />'.$lang['order_linkname'].'</a></span>';
    ...
    <tr>
     <td class="autorcell" rowspan="2" valign="top"><?php
      ...
      if (isset($_SESSION[$settings['session_prefix'].'user_id']) && $thread["user_id"] > 0)
       {
        $show_userdata_linktitle_x = str_replace("[name]", htmlspecialchars(stripslashes($thread["name"])), $lang['show_userdata_linktitle']);
        ?><a class="userlink" name="<?php echo "p".$thread["id"]; ?>" href="user.php?id=<?php echo $thread["user_id"]; ?>" title="<?php echo $show_userdata_linktitle_x; ?>"><?php if ($mark_admin==true) { ?><span class="admin-highlight"><?php } elseif ($mark_mod==true) { ?><span class="mod-highlight"><?php } ?><b><?php echo htmlspecialchars(stripslashes($thread["name"])); ?></b><?php if ($settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } if ($mark_admin==true||$mark_mod==true) { ?></span><?php } ?></a><br /><?php
       }
      // ansonsten nur den Namen anzeigen:
      else
       {
        ?>
        <a id="<?php echo "p".$thread["id"]; ?>"><?php if ($mark_admin==true) { ?><span class="admin-highlight"><?php } elseif ($mark_mod==true) { ?><span class="mod-highlight"><?php } ?><b><?php echo htmlspecialchars(stripslashes($thread["name"])); ?></b><?php if ($thread["user_id"] > 0 && $settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } ?></a><?php if ($mark_admin==true||$mark_mod==true) { ?></span><?php } ?><br />
        <?php
       }
       if (empty($thread["hide_email"])) $thread["hide_email"] = 0;
       if (($thread["email"]!="" && $thread["hide_email"] != 1) or $thread["hp"]!="") { echo "<br />"; }
       if ($thread["hp"]!="") { if (substr($thread["hp"],0,7) != "http://" && substr($thread["hp"],0,8) != "https://" && substr($thread["hp"],0,6) != "ftp://" && substr($thread["hp"],0,9) != "gopher://" && substr($thread["hp"],0,7) != "news://") $thread["hp"] = "http://".$thread["hp"]; echo "<a href=\"" . $thread["hp"] ."\" title=\"".htmlspecialchars(stripslashes($thread["hp"]))."\"><img src=\"img/homepage.gif\" alt=\"".$lang['homepage_alt']."\" width=\"13\" height=\"13\" /></a>"; }
       if (($thread["email"]!="" && $thread["hide_email"] != 1) && $thread["hp"]!="") { echo "&nbsp;"; }
       #if ($thread["email"]!="" && $thread["hide_email"] != 1) { echo "<a href=\"mailto:" . $thread["email"] ."\" title=\"".htmlspecialchars(stripslashes($thread["email"]))."\"><img src=\"img/email.gif\" alt=\"".$lang['email_alt']."\" width=\"14\" height=\"10\" /></a>"; }
       if ($thread["email"]!="" && $thread["hide_email"] != 1 && isset($page) && isset($order) && isset($category)) { echo '<a href="contact.php?id='.$thread["id"].'&amp;page='.$page.'&amp;category='.$category.'&amp;order='.$order.'&amp;view=board"><img src="img/email.gif" alt="'.$lang['email_alt'].'" title="'.str_replace("[name]", htmlspecialchars(stripslashes($thread["name"])), $lang['email_to_user_linktitle']).'" width="13" height="10" /></a>'; }
       elseif ($thread["email"]!="" && $thread["hide_email"] != 1) { echo '<a href="contact.php?id='.$thread.'&amp;view=board"><img src="img/email.gif" alt="'.$lang['email_alt'].'" width="13" height="10" title="'.str_replace("[name]", htmlspecialchars(stripslashes($thread["name"])), $lang['email_to_user_linktitle']).'" /></a>'; }
       if (($thread["email"]!="" && $thread["hide_email"] != 1) or $thread["hp"]!="") { echo "<br />"; }
       echo "<br />";
       if ($thread["place"]!="") { echo htmlspecialchars(stripslashes($thread["place"])); echo ", <br />"; }
       echo strftime($lang['time_format'],$thread["Uhrzeit"]);
       if ($thread["edited_diff"] > 0 && $thread["edited_diff"] > $thread["time"] && $settings['show_if_edited'] == 1) { $board_em = str_replace("[name]", htmlspecialchars(stripslashes($thread["edited_by"])), $lang['board_edited_marking']); $board_em = str_replace("[time]", strftime($lang['time_format'],$thread["e_Uhrzeit"]), $board_em); ?><br /><span class="xsmall"><?php echo $board_em; ?></span><?php }
    ...
    <tr>
     <td class="autorcell" rowspan="2" valign="top"><?php
      ...
      if (isset($_SESSION[$settings['session_prefix'].'user_id']) && $entrydata["user_id"] > 0)
       {
        $show_userdata_linktitle_x = str_replace("[name]", htmlspecialchars(stripslashes($entrydata["name"])), $lang['show_userdata_linktitle']);
        ?><a id="<?php echo "p".$entrydata["id"]; ?>" href="user.php?id=<?php echo $entrydata["user_id"]; ?>" title="<?php echo $show_userdata_linktitle_x; ?>"><?php if ($mark_admin==true) { ?><span class="admin-highlight"><?php } elseif ($mark_mod==true) { ?><span class="mod-highlight"><?php } ?><b><?php echo htmlspecialchars(stripslashes($entrydata["name"])); ?></b><?php if ($settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } if ($mark_admin==true||$mark_mod==true) { ?></span><?php } ?></a><br /><?php
       }
      // ansonsten nur den Namen anzeigen:
      else
       {
        ?>
        <a id="<?php echo "p".$entrydata["id"]; ?>"><?php if ($mark_admin==true) { ?><span class="admin-highlight"><?php } elseif ($mark_mod==true) { ?><span class="mod-highlight"><?php } ?><b><?php echo htmlspecialchars(stripslashes($entrydata["name"])); ?></b><?php if ($entrydata["user_id"] > 0 && $settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } ?></a><?php if ($mark_admin==true||$mark_mod==true) { ?></span><?php } ?><br />
        <?php
       }

        if (empty($entrydata["hide_email"])) $entrydata["hide_email"] = 0;
        if (($entrydata["email"]!="" && $entrydata["hide_email"] != 1) or $entrydata["hp"]!="") { echo "<br />"; }
        if ($entrydata["hp"]!="") { if (substr($entrydata["hp"],0,7) != "http://" && substr($entrydata["hp"],0,8) != "https://" && substr($entrydata["hp"],0,6) != "ftp://" && substr($entrydata["hp"],0,9) != "gopher://" && substr($entrydata["hp"],0,7) != "news://") $entrydata["hp"] = "http://".$entrydata["hp"]; echo "<a href=\"" . $entrydata["hp"] ."\" title=\"".htmlspecialchars(stripslashes($entrydata["hp"]))."\"><img src=\"img/homepage.gif\" alt=\"".$lang['homepage_alt']."\" width=\"13\" height=\"13\" /></a>"; }
        if (($entrydata["email"]!="" && $entrydata["hide_email"] != 1) && $entrydata["hp"]!="") { echo "&nbsp;"; }
        #if ($entrydata["email"]!="" && $entrydata["hide_email"] != 1) { echo "<a href=\"mailto:" . $entrydata["email"] ."\"title=\"".htmlspecialchars(stripslashes($entrydata["email"]))."\"><img src=\"img/email.gif\" alt=\"".$lang['email_alt']."\" width=\"14\" height=\"10\" /></a>"; }
        if ($entrydata["email"]!="" && $entrydata["hide_email"] != 1 && isset($page) && isset($order) && isset($category)) { echo '<a href="contact.php?id='.$entrydata["id"].'&amp;page='.$page.'&amp;category='.$category.'&amp;order='.$order.'&amp;view=board"><img src="img/email.gif" alt="'.$lang['email_alt'].'" title="'.str_replace("[name]", htmlspecialchars(stripslashes($entrydata["name"])), $lang['email_to_user_linktitle']).'" width="13" height="10" /></a>'; }
        elseif ($entrydata["email"]!="" && $entrydata["hide_email"] != 1) { echo '<a href="contact.php?id='.$entrydata["id"].'&amp;view=board" title="'.str_replace("[name]", htmlspecialchars(stripslashes($entrydata["name"])), $lang['email_to_user_linktitle']).'"><img src="img/email.gif" alt="'.$lang['email_alt'].'" width="13" height="10" /></a>'; }
        if (($entrydata["email"]!="" && $entrydata["hide_email"] != 1) or $entrydata["hp"]!="") { echo "<br />"; }
        echo "<br />";
        if ($entrydata["place"]!="") { echo htmlspecialchars(stripslashes($entrydata["place"])); echo ", <br />"; }
        echo strftime($lang['time_format'],$entrydata["Uhrzeit"]); ?>
        <?php if ($entrydata["edited_diff"] > 0 && $entrydata["edited_diff"] > $entrydata["time"] && $settings['show_if_edited'] == 1) { $board_em = str_replace("[name]", htmlspecialchars(stripslashes($entrydata["edited_by"])), $lang['board_edited_marking']); $board_em = str_replace("[time]", strftime($lang['time_format'],$entrydata["e_Uhrzeit"]), $board_em); ?><br /><span class="xsmall"><?php echo $board_em; ?></span><?php } ?>
