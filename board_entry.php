      ...
      if (isset($_SESSION[$settings['session_prefix'].'user_id']) && $thread["user_id"] > 0)
       {
        ...
        ?><a class="userlink" name="<?php echo "p".$thread["id"]; ?>" href="user.php?id=<?php echo $thread["user_id"]; ?>" title="<?php echo $show_userdata_linktitle_x; ?>"><?php if ($mark_admin==true) { ?><span class="admin-highlight"><?php } elseif ($mark_mod==true) { ?><span class="mod-highlight"><?php } ?><b><?php echo htmlsc($thread["name"]); ?></b><?php if ($settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } if ($mark_admin==true||$mark_mod==true) { ?></span><?php } ?></a><br /><?php
       }
      // ansonsten nur den Namen anzeigen:
      else
       {
        ?>
        <a id="<?php echo "p".$thread["id"]; ?>"><?php if ($mark_admin==true) { ?><span class="admin-highlight"><?php } elseif ($mark_mod==true) { ?><span class="mod-highlight"><?php } ?><b><?php echo htmlsc($thread["name"]); ?></b><?php if ($thread["user_id"] > 0 && $settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } ?></a><?php if ($mark_admin==true||$mark_mod==true) { ?></span><?php } ?><br />
        <?php
       }
       if (empty($thread["hide_email"])) $thread["hide_email"] = 0;
       if (($thread["email"]!="" && $thread["hide_email"] != 1) or $thread["hp"]!="") { echo "<br />"; }
       if ($thread["hp"]!="") { if (substr($thread["hp"],0,7) != "http://" && substr($thread["hp"],0,8) != "https://" && substr($thread["hp"],0,6) != "ftp://" && substr($thread["hp"],0,9) != "gopher://" && substr($thread["hp"],0,7) != "news://") $thread["hp"] = "http://".$thread["hp"]; echo '<a href="' . $thread["hp"] .'" title="'.htmlsc($thread["hp"]).'"><img src="img/homepage.gif" alt="'.$lang['homepage_alt'].'" width="13" height="13" /></a>'; }
       if (($thread["email"]!="" && $thread["hide_email"] != 1) && $thread["hp"]!="") { echo "&nbsp;"; }
       #if ($thread["email"]!="" && $thread["hide_email"] != 1) { echo '<a href="mailto:' . $thread["email"] .'" title="'.htmlsc($thread["email"]).'"><img src="img/email.gif" alt="'.$lang['email_alt'].'" width="14" height="10" /></a>'; }
       if ($thread["email"]!="" && $thread["hide_email"] != 1 && isset($page) && isset($order) && isset($category)) { echo '<a href="contact.php?id='.$thread["id"].'&amp;page='.$page.'&amp;category='.$category.'&amp;order='.$order.'&amp;view=board"><img src="img/email.gif" alt="'.$lang['email_alt'].'" title="'.str_replace("[name]", htmlsc($thread["name"]), $lang['email_to_user_linktitle']).'" width="13" height="10" /></a>'; }
       elseif ($thread["email"]!="" && $thread["hide_email"] != 1) { echo '<a href="contact.php?id='.$thread.'&amp;view=board"><img src="img/email.gif" alt="'.$lang['email_alt'].'" width="13" height="10" title="'.str_replace("[name]", htmlsc($thread["name"]), $lang['email_to_user_linktitle']).'" /></a>'; }
       if (($thread["email"]!="" && $thread["hide_email"] != 1) or $thread["hp"]!="") { echo "<br />"; }
       echo "<br />";
      ...
      if (isset($_SESSION[$settings['session_prefix'].'user_id']) && $entrydata["user_id"] > 0)
       {
        ...
        ?><a id="<?php echo "p".$entrydata["id"]; ?>" href="user.php?id=<?php echo $entrydata["user_id"]; ?>" title="<?php echo $show_userdata_linktitle_x; ?>"><?php if ($mark_admin==true) { ?><span class="admin-highlight"><?php } elseif ($mark_mod==true) { ?><span class="mod-highlight"><?php } ?><b><?php echo htmlsc($entrydata["name"]); ?></b><?php if ($settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } if ($mark_admin==true||$mark_mod==true) { ?></span><?php } ?></a><br /><?php
       }
      // ansonsten nur den Namen anzeigen:
      else
       {
        ?>
        <a id="<?php echo "p".$entrydata["id"]; ?>"><?php if ($mark_admin==true) { ?><span class="admin-highlight"><?php } elseif ($mark_mod==true) { ?><span class="mod-highlight"><?php } ?><b><?php echo htmlsc($entrydata["name"]); ?></b><?php if ($entrydata["user_id"] > 0 && $settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } ?></a><?php if ($mark_admin==true||$mark_mod==true) { ?></span><?php } ?><br />
        <?php
       }

        if (empty($entrydata["hide_email"])) $entrydata["hide_email"] = 0;
        if (($entrydata["email"]!="" && $entrydata["hide_email"] != 1) or $entrydata["hp"]!="") { echo "<br />"; }
        if ($entrydata["hp"]!="") { if (substr($entrydata["hp"],0,7) != "http://" && substr($entrydata["hp"],0,8) != "https://" && substr($entrydata["hp"],0,6) != "ftp://" && substr($entrydata["hp"],0,9) != "gopher://" && substr($entrydata["hp"],0,7) != "news://") $entrydata["hp"] = "http://".$entrydata["hp"]; echo '<a href="' . $entrydata["hp"] .'" title="'.htmlsc($entrydata["hp"]).'"><img src=\
        "img/homepage.gif" alt="'.$lang['homepage_alt'].'" width="13" height="13" /></a>'; }
        ...
        if ($entrydata["email"]!="" && $entrydata["hide_email"] != 1 && isset($page) && isset($order) && isset($category)) { echo '<a href="contact.php?id='.$entrydata["id"].'&amp;page='.$page.'&amp;category='.$category.'&amp;order='.$order.'&amp;view=board"><img src="img/email.gif" alt="'.$lang['email_alt'].'" title="'.str_replace("[name]", htmlsc($entrydata["name"]), $lang['email_to_user_linktitle']).'" width="13" height="10" /></a>'; }
        elseif ($entrydata["email"]!="" && $entrydata["hide_email"] != 1) { echo '<a href="contact.php?id='.$entrydata["id"].'&amp;view=board" title="'.str_replace("[name]", htmlsc($entrydata["name"]), $lang['email_to_user_linktitle']).'"><img src="img/email.gif" alt="'.$lang['email_alt'].'" width="13" height="10" /></a>'; }
        if (($entrydata["email"]!="" && $entrydata["hide_email"] != 1) or $entrydata["hp"]!="") { echo "<br />"; }
        echo "<br />";
        ...
        <span class="xsmall"><br /><br /><!--<a href="<?php echo "#p".$entrydata["pid"]; ?>">-->@ <?php echo htmlsc($posting_a["name"]); ?><!--</a>--></span>
