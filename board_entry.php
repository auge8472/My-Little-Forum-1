    ...
    <tr>
     <td class="autorcell" rowspan="2" valign="top"><?php
      ...
      // ansonsten nur den Namen anzeigen:
       ...
       if ($thread["hp"]!="") { if (mb_substr($thread["hp"], 0, 7) != "http://" && mb_substr($thread["hp"], 0, 8) != "https://" && mb_substr($thread["hp"], 0, 6) != "ftp://" && mb_substr($thread["hp"], 0, 9) != "gopher://" && mb_substr($thread["hp"], 0, 7) != "news://") $thread["hp"] = "http://".$thread["hp"]; echo "<a href=\"" . $thread["hp"] ."\" title=\"".htmlsc($thread["hp"])."\"><img src=\"img/homepage.gif\" alt=\"".$lang['homepage_alt']."\" width=\"13\" height=\"13\" /></a>"; }
