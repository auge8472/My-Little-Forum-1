...
function update17to18() {
	...
	@mysqli_query($connid, "ALTER TABLE ". $db_settings['forum_table'] ." CHANGE uniqid uniqid varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL, CHANGE name name varchar(64) COLLATE utf8mb4_bin DEFAULT NULL, CHANGE email email varchar(255) CHARACTER SET utf8mb3 DEFAULT NULL, CHANGE hp hp varchar(255) CHARACTER SET utf8mb3 DEFAULT NULL, CHANGE ip ip varchar(128) CHARACTER SET utf8mb3 DEFAULT NULL, ADD INDEX username (name)") or $errors[] = str_replace("[table]",$db_settings['forum_table'],$lang_add['alter_table_error']) ." (MySQL: ".mysqli_error($connid).")";
...
if (isset($_POST['form_submitted'])) {
	...
	if ($installation_mode == 'installation' && empty($errors)) {
     ...
     ip varchar(128) CHARACTER SET utf8mb3 DEFAULT NULL,
     text text NOT NULL,
