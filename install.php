...
function update17to18() {
	...
	@mysqli_query($connid, "ALTER TABLE ". $db_settings['category_table'] ." CHANGE category category varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_general_ci NOT NULL DEFAULT ''") or $errors[] = $lang_add['alter_table_error']. " (MySQL: ".mysqli_error($connid).")";
