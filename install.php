  ...
  if($installation_mode=='installation' && empty($errors))
   {
    ...
    if (empty($errors))
     ...
     user_name varchar(255) COLLATE utf8mb4_bin NULL DEFAULT NULL,
     user_real_name varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
     user_pw varchar(255) COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
     user_email varchar(255) CHARACTER SET utf8 NULL DEFAULT NULL,
     hide_email tinyint(4) default 0,
     user_hp varchar(255) CHARACTER SET utf8 NULL default NULL,
     user_place varchar(255) COLLATE utf8mb4_unicode_ci NULL default NULL,
     signature varchar(255) COLLATE utf8mb4_unicode_ci NULL default NULL,
     profile text COLLATE utf8mb4_unicode_ci NOT NULL,
     logins int(11) NOT NULL default 0,
     last_login timestamp NULL default NULL,
     last_logout timestamp NULL default NULL,
     user_ip varchar(255) CHARACTER SET utf8 NULL default NULL,
     registered timestamp NULL default NULL,
     user_view varchar(255) CHARACTER SET utf8 NULL default NULL,
     ...
     pwf_code varchar(255) COLLATE utf8mb4_unicode_ci NULL default NULL,
     ...
     ip char(15) CHARACTER SET utf8 NOT NULL DEFAULT '',
