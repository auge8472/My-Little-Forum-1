...
switch ($action)
	...
	case "debug":
		...
		echo ' /></td>'."\n";
		echo '</tr><tr>'."\n";
		echo '<td class="c"><label for="debug-session">'.$lang_add['debug_session'].'</label><br />';
		echo '<span class="info">'.$lang_add['debug_session_d'].'</span></td>'."\n";
		echo '<td class="d"><input type="radio" name="debug_type" id="debug-session" value="session"';
