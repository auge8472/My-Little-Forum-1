...
switch ($action)
	...
	case "debug":
		...
		$tBody = str_replace('{CheckNone}', htmlspecialchars($cn), $tBody);
		...
		$tBody = str_replace('{CheckLang}', htmlspecialchars($cl), $tBody);
		...
		$tBody = str_replace('{CheckSession}', htmlspecialchars($cs), $tBody);
		...
		$tBody = str_replace('{CheckCSS}', htmlspecialchars($cc), $tBody);
