      ...
      if (isset($_SESSION[$settings['session_prefix'].'user_id']) && $entrydata["user_id"] > 0)
       {
        ...
        ?><a id="<?php echo "p".$entrydata["id"]; ?>" href="user.php?id=<?php echo $entrydata["user_id"]; ?>" title="<?php echo $show_userdata_linktitle_x; ?>"><b><?php echo htmlsc(stripslashes($entrydata["name"])); ?></b><?php if ($settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } ?></a><br /><?php
       }
      // ansonsten nur den Namen anzeigen:
      else
       {
        ?>
        <a id="<?php echo "p".$entrydata["id"]; ?>"><b><?php echo htmlsc(stripslashes($entrydata["name"])); ?></b><?php if ($entrydata["user_id"] > 0 && $settings['show_registered'] ==1) { ?><img src="img/registered.gif" alt="(R)" width="10" height="10" title="<?php echo $lang['registered_user_title']; ?>" /><?php } ?></a><br />
        <?php
       }
        ...
        if ($entrydata["email"]!="" && $entrydata["hide_email"] != 1 && isset($page) && isset($order) && isset($category)) { echo '<a href="contact.php?id='.$entrydata["id"].'&amp;page='.$page.'&amp;category='.$category.'&amp;order='.$order.'&amp;view=mix" title="'.str_replace("[name]", htmlsc(stripslashes($entrydata["name"])), $lang['email_to_user_linktitle']).'"><img src="img/email.gif" alt="'.$lang['email_alt'].'" width="13" height="10" /></a>'; }
        elseif ($entrydata["email"]!="" && $entrydata["hide_email"] != 1) { echo '<a href="contact.php?id='.$entrydata["id"].'&amp;view=mix" title="'.str_replace("[name]", htmlsc(stripslashes($entrydata["name"])), $lang['email_to_user_linktitle']).'"><img src="img/email.gif" alt="'.$lang['email_alt'].'" width="13" height="10" /></a>'; }
        if (($entrydata["email"]!="" && $entrydata["hide_email"] != 1) or $entrydata["hp"]!="") { echo "<br />"; }
        echo "<br />";
        ...
        <?php if ($entrydata["pid"]!=0) { ?><span class="xsmall"><br /><br />@ <?php echo htmlsc(stripslashes($posting_a["name"])); ?></span><?php } ?>
        <?php
