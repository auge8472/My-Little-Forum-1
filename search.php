...
else echo "forum_entry.php?id=".$entrydata["id"]; ?>"><?php echo htmlspecialchars(stripslashes($entrydata["subject"])); ?></a> <?php echo $search_author_info_x; if(isset($categories[$entrydata["category"]]) && $categories[$entrydata["category"]]!='') echo " <span class=\"category\">(".$categories[$entrydata["category"]].")</span>"; ?></p><?php }
}
?>
<br />
<?php echo $footer; ?>